...
AnguloA=input('Digite o ângulo de A: '); % ângulo entre x e a.
AnguloB=input('Digite o ângulo de B: '); % ângulo entre a e b.
AnguloC=input('Digite o ângulo de C: '); % ângulo entre a e c.
...
%y1=-AnguloGrafico.*x+FiY; %Tentando a continuação da linha
%axis([-70 100,-80 80])
%hold on;
%plot (x,y1,'b');
